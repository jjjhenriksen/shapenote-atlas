#!/usr/bin/env python3
"""Create a source-derived, fail-closed correction for Sacred Harp 265."""
...
SOURCE = ROOT / "work/omr/265-gwehelog/source.mxl"
SOURCE_IMAGE = ROOT / "work/omr/265-gwehelog/source.jpg"
RETAINED_SOURCE_COPY = ROOT / "work/source-images/2025/265-gwehelog-fd0a910e8f.jpg"
OUTPUT = ROOT / "work/omr/autonomous-transcriptions/2025/265-gwehelog-source-correction-v2.mxl"
AUDIT = ROOT / "work/source-transcriptions/2025/265-source-shape-autonomous-blocked-comparison.json"
PRIOR_REVIEW = ROOT / "work/omr/source-shape-review-drafts/2025/265-source-shape-review.mxl"

# Four-shape spelling for A major: A=fa, B=sol, C=la, D=fa,
# E=sol, F=la, G=mi. Accidentals in the retained OMR are untouched.
...
def transform() -> tuple[bytes, dict[str, object], dict[str, list[dict[str, str]]], dict[str, list[dict[str, str]]]]:
    ...
    provenance = {
        ...
        "atlas-source-image": "work/omr/265-gwehelog/source.jpg",
        "atlas-source-image-sha256": sha256(SOURCE_IMAGE),
        "atlas-retained-source-copy": "work/source-images/2025/265-gwehelog-fd0a910e8f.jpg",
        "atlas-retained-source-copy-sha256": sha256(RETAINED_SOURCE_COPY),
        "atlas-source-key": "A major",
        "atlas-source-mode": "major",
        "atlas-source-time-signature": "3/4",
        "atlas-source-meter": "Common Meter (8,6,8,6)",
        "atlas-source-title-and-credits": "GWEHELOG. C.M.; Isaac Watts, 1721; Matthew Parkinson, 2015",
        ...
        "atlas-blocker": "The immutable page visibly prints GWEHELOG. C.M., A major, 3/4, four vocal parts, lyrics, and a terminal barline. Audiveris reports 11 raw measures in one system, matching the canonical OMR's 11 measures per part, but the OMR has sparse event/duration grouping, no aligned lyrics, no source-confirmed shapes, and incomplete structured semantics. A diagonal DO NOT COPY watermark crosses the central systems and lyric area. No notation was synthesized.",
    }
...
def main() -> int:
    ...
    retained_image_hash = sha256(RETAINED_SOURCE_COPY)
    ...
    blocking = [
        "The immutable page establishes A major, 3/4, four parts, visible lyrics, and a terminal barline, but the retained OMR has no directly aligned lyrics or source-confirmed per-note shapes.",
        "Audiveris reports 11 raw measures in one system and the canonical OMR contains 11 measures per part, but the event/duration grouping is sparse and not proven note-for-note against the page.",
        "The retained OMR contains 81 note elements, 78 pitched events, 3 rests, and 7 empty measures; most measures are under-full against 3/4, so source rhythm and rest placement are unresolved.",
        "The diagonal watermark intersects central notation and lyrics; no obscured note, lyric, duration, repeat, ending, or shape was inferred.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=265",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/200-299/265-Gwehelog/265.jpg",
            "sourceImagePath": "work/omr/265-gwehelog/source.jpg",
            "sourceImageSha256": source_image_hash,
            "immutable": True,
            "sourceImageVariants": [{
                "path": "work/source-images/2025/265-gwehelog-fd0a910e8f.jpg",
                "sha256": retained_image_hash,
                "dimensions": "1312x476",
                "relationship": "retained same-page copy; distinct JPEG bytes"
            }],
            "directObservations": {
                "header": "GWEHELOG. C.M.",
                "key": "A major",
                ...
                "composer": "Matthew Parkinson, 2015",
                "lyricist": "Isaac Watts, 1721",
                "parts": 4,
                "clefOrder": ["treble", "treble", "treble", "bass"],
                "sourceMeasuresByPart": {"P1": 11, "P2": 11, "P3": 11, "P4": 11},
                "sourceLyricsVisible": True,
                "sourceRepeatEnding": "terminal barline visible; no repeat or numbered ending marker observed",
                "watermarkAffectedRegions": "central systems and lyric area"
            }
        },
        "inputOmr": {
            "path": "work/omr/265-gwehelog/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
            "parts": 4,
            "measuresByPart": {"P1": 11, "P2": 11, "P3": 11, "P4": 11},
            "eventsByPart": {"P1": 17, "P2": 24, "P3": 24, "P4": 16},
            "pitchedEventsByPart": {"P1": 16, "P2": 24, "P3": 24, "P4": 14},
            "restEventsByPart": {"P1": 1, "P2": 0, "P3": 0, "P4": 2},
            "noteheads": 0,
            "lyrics": 0,
            "timeSignatures": 4,
            "audiverisRawMeasures": 11,
            "audiverisMeasuresBySystem": [11],
            "durationAudit": summary["durationFailuresAgainst3_4"],
            "statusReason": "Matching part/measure topology is not sufficient: event durations, rests, lyrics, and shape identity are not source-proven."
        },
        "priorReviewDraft": {
            "path": "work/omr/source-shape-review-drafts/2025/265-source-shape-review.mxl",
            "sha256": prior_review_hash,
            "status": "preserved-review-only-witness-not-used-as-authority"
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/265-gwehelog-source-correction-v2.mxl",
            "sha256": draft_hash,
            "summary": summary,
            ...
            "corrections": [
                "source A-major key and explicit major mode",
                "source 3/4 time signature on every retained measure",
                "four-shape noteheads added to every retained pitched event",
                "canonical and retained source-image provenance recorded",
                "lyrics, repeats, endings, missing events, and uncertain durations intentionally omitted"
            ]
        },
        "comparisonEvidence": {
            "sourceScanInspected": True,
            "sourceScanPath": "work/omr/265-gwehelog/source.jpg",
            "sourceScanSha256": source_image_hash,
            "retainedSourceCopyInspected": "work/source-images/2025/265-gwehelog-fd0a910e8f.jpg",
            "method": "full-resolution direct source-image inspection plus canonical OMR event, duration, topology, lyric, and provenance audit; prior shape-review draft retained as distinct witness",
            "blockingFindings": blocking
        },
        "blockingFindings": blocking,
        "blockingReason": "Autonomous promotion is blocked because the canonical OMR matches the source's 11-measure four-part outline but has 7 empty measures and under-full 3/4 event groupings, no aligned lyrics, no direct per-note shape proof, and no structured repeat/ending evidence. The watermark intersects central notation and lyrics. The derivative preserves detected events and adds source metadata/shapes without inventing notation.",
        ...
        "policy": "Immutable 2025 source remains authoritative. OMR and derived shape tags are review work product only and cannot authorize promotion without direct event-level and shape evidence."
    }
    AUDIT.write_text(json.dumps(audit, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(json.dumps({"record": "sh2025/265", "status": audit["comparisonStatus"], "sourceImageSha256": source_image_hash, "retainedSourceImageSha256": retained_image_hash, "inputOmrSha256": source_hash, "priorReviewSha256": prior_review_hash, "correctedDraftSha256": draft_hash, "summary": summary, "audit": str(AUDIT.relative_to(ROOT))}, ensure_ascii=False, sort_keys=True))
    return 0
