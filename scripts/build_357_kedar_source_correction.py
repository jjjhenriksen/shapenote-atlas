#!/usr/bin/env python3
"""Record a source-faithful, fail-closed Kedar comparison."""
...
SOURCE_IMAGE = ROOT / "work/omr/357-kedar/source.jpg"
RETAINED_IMAGE = ROOT / "work/source-images/2025/357-kedar-05ec0f3267.jpg"
SOURCE_OMR = ROOT / "work/omr/357-kedar/source.mxl"
NORMALIZED_OMR = ROOT / "work/omr/cleaned-normalized-v2-357-kedar-05ec0f3267/work__source-images__2025__357-kedar-05ec0f3267.mxl"
DRAFT_INPUT = ROOT / "work/omr/source-shape-review-drafts/2025/357-source-shape-review.mxl"
OUTPUT = ROOT / "work/omr/autonomous-transcriptions/2025/357-kedar-source-correction-v2.mxl"
AUDIT = ROOT / "work/source-transcriptions/2025/357-source-shape-autonomous-blocked-comparison.json"
...
def main() -> int:
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=357",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/300-399/357-Kedar/357.jpg",
            ...
            "directObservations": {
                ...
                "parts": 4,
                "systems": 1,
                "sourceMeasureCount": 10,
                "measuresByPart": {"P1": 10, "P2": 10, "P3": 10, "P4": 10},
                "lyricsVisible": True,
        ...
        "correctedDraft": {
            ...
            "encodingBasis": "normalized-v2 source-scan OMR pitch steps plus observed A-major key and 4/4 meter; no event, lyric, repeat, or shape is source-verified",
        },
        "comparisonEvidence": {
            ...
            "imageGeometry": "1317x500 for both source-image files; bytes differ, so hashes are preserved separately",
            ...
            "measureTopology": {"rawSourceOmr": source_stats["measuresByPart"], "normalizedOmr": normalized_stats["measuresByPart"], "draft": draft_stats["measuresByPart"], "sourceVisible": {"P1": 10, "P2": 10, "P3": 10, "P4": 10}},
            ...
            "blockingFindings": [
                "The immutable page visibly prints A major, 4/4, four vocal parts, lyrics, and a terminal double bar.",
                "The retained raw source OMR contains 79 events (21/27/18/12 pitches plus one rest), while normalized-v2 contains 89 events across 11 measures per part; this topology/event divergence is not source proof and cannot be reconciled by inference.",
                "The OMR-derived draft has no lyrics, and its pitch, rhythm, rest, measure, and per-note four-shape identities are not independently proven against the page.",
                "The diagonal DO NOT COPY watermark intersects the middle source notation and lyrics, so obscured content was not fabricated.",
                "No exact-edition authorized structured witness exists for this record.",
            ],
        },
        "blockingReason": "Autonomous promotion is blocked: raw and normalized OMR disagree in measure topology and event coverage, and neither establishes source-exact pitches, rhythms, rests, lyrics, or per-note shapes. The source scan also contains watermark-obscured notation. No missing material was synthesized.",
