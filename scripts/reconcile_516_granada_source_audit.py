#!/usr/bin/env python3
"""Reconcile Granada's retained scan OMR into an autonomous block."""
...
SOURCE_IMAGE = ROOT / "work/omr/516-granada/source.jpg"
RETAINED_IMAGE = ROOT / "work/source-images/2025/516-granada-9b43374b79.jpg"
RAW_OMR = ROOT / "work/omr/516-granada/source.mxl"
OUTPUT = ROOT / "work/omr/autonomous-transcriptions/2025/516-granada-source-correction.mxl"
AUDIT = ROOT / "work/source-transcriptions/2025/516-source-shape-autonomous-blocked-comparison.json"
...
def update_xml(xml_bytes: bytes, source_hash: str, raw_hash: str) -> bytes:
    ...
    for part in children(root, "part"):
        ...
        # The scan prints B-flat Major: two flats.
    ...
    fields = {
        "atlas-review-queue-id": "sh2025/516",
...
def main() -> int:
    ...
    blocking = [
        "The immutable page visibly identifies GRANADA. C.M., B-flat major, 4/4, Charles Wesley (1742), Andy Ditzler (2018), four vocal parts, and source-visible lyrics. A repeat with numbered first/second endings and a terminal double bar are visible; a diagonal DO NOT COPY watermark intersects the middle/lower systems.",
        "Audiveris reports 21 raw measures across two systems (11 and 10), while the retained MXL exports 19 measures per part. The retained score contains 155 pitched events, 15 empty exported measures, and 63 of 76 exported part-measures fail the 4/4 duration target at divisions=2. The source event stream, durations, and measure topology are therefore not proven complete.",
        ...
        "No authorized exact-edition structured Granada witness was available. Alternate-edition records were not used to fill notes, durations, lyrics, repeats, or shapes.",
    ]
    audit = {
        "queueId": "sh2025/516", "edition": "Sacred Harp, 2025 Edition", "songNo": "516", "title": "Granada",
        "comparisonStatus": "autonomously-blocked", "autonomousDecision": "blocked", "safeToPromote": False, "humanReviewRequired": False,
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=516", "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/500-599/516-Granada/516.jpg",
            "sourceImagePath": str(SOURCE_IMAGE.relative_to(ROOT)), "sourceImageSha256": source_hash, "immutable": True,
            "directObservations": {
                "header": "GRANADA. C.M.", "composer": "Charles Wesley, 1742", "arranger": "Andy Ditzler, 2018", "key": "B-flat major", "mode": "major", "timeSignature": "4/4", "meter": "Common Meter (8,8,8,8)", "parts": 4,
                "sourceRawMeasuresFromAudiveris": 21, "sourceRawMeasuresBySystem": [11, 10], "exportedMeasuresByPart": {"P1": 19, "P2": 19, "P3": 19, "P4": 19},
        ...
        "candidateWitness": {"available": False, "candidateRole": "No authorized exact-edition structured Granada witness was available; alternate editions were not used."},
        ...
        "blockingReason": "Autonomous promotion is blocked by the 21-versus-19 measure topology discrepancy, 63-of-76 retained-OMR 4/4 duration failures, 15 empty exported measures, absent lyrics/repeat semantics/per-note shape encoding, watermark-intersected notation, and lack of an authorized exact-edition structured witness. The corrected derivative remains review-only.",
