#!/usr/bin/env python3
"""Create a fail-closed, source-derived Clayton OMR derivative."""
...
SOURCE = ROOT / "work" / "omr" / "531-clayton" / "source.mxl"
IMAGE = ROOT / "work" / "omr" / "531-clayton" / "source.jpg"
OUTPUT = ROOT / "work" / "omr" / "autonomous-transcriptions" / "2025" / "531-autonomous-blocked.mxl"
AUDIT = ROOT / "work" / "source-transcriptions" / "2025" / "531-clayton-autonomous-comparison.json"

# Clayton is printed in C major; the four-shape syllables follow the source key.
...
def transform() -> tuple[bytes, dict[str, object]]:
    with zipfile.ZipFile(SOURCE) as archive:
        ...
        for name, value in {
            "atlas-queue-id": "sh2025/531",
            "atlas-transcription-status": "autonomously-blocked",
            "atlas-safe-to-promote": "false",
            "atlas-source-image": "work/omr/531-clayton/source.jpg",
            ...
            "atlas-shape-encoding": "derived four-shape spelling from retained OMR pitches and source-visible C-major key; not source-verified per event",
            ...
            "atlas-blocker": "The source visibly has a four-part C-major 3/2 score, while the retained OMR collapses the page to seven measures per part. Its duration totals fail the 3-unit 3/2 target in every retained measure: P1 m1=2,m2=2,m3=14,m4=16,m5=2,m6=0,m7=2; P2 m1=0,m2=2,m3=42,m4=23,m5=4,m6=2,m7=2; P3 m1=2,m2=2,m3=31,m4=8,m5=2,m6=2,m7=4; and P4 m1=0,m2=2,m3=14,m4=10,m5=2,m6=2,m7=2. P1 m6 and P2/P4 m1 are blank although the source shows notation. The OMR omits the source time signature and has incomplete key metadata; watermark intersections remain separately unresolved only in the middle systems.",
        }.items():
...
def main() -> int:
    ...
    blocking = [
        "The retained source scan visibly prints CLAYTON. L.M., C major, 3/2, and four vocal parts; its barline geometry contains more source divisions than the seven retained OMR measures per part.",
        "The retained OMR has seven measures per part, but every retained measure fails the source 3/2 duration target; P1 m6 and P2/P4 m1 are blank although the source visibly contains notation.",
        "The retained OMR omits the source time signature and has incomplete key metadata; the derivative corrects source metadata without silently rewriting event pitches.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=531",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/500-599/531-Clayton/531.jpg",
            "sourceImagePath": "work/omr/531-clayton/source.jpg",
            ...
            "directObservations": {
                ...
                "parts": 4,
                "sourceMeasureStructure": "source scan visibly contains more barline divisions than the retained seven-measure OMR; exact source count not asserted here",
                "watermarkAffectedRegions": "middle-system note intersections only",
            },
        },
        "inputOmr": {
            "path": "work/omr/531-clayton/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/531-autonomous-blocked.mxl",
            "sha256": output_hash,
            "summary": summary,
            "corrections": [
                "four part structure preserved",
                "source C-major key/mode",
        ...
        "comparisonEvidence": {
            ...
            "renderedSourcePath": "work/omr/531-clayton/source.jpg",
            "renderedDraftInputs": ["work/omr/531-clayton/source.mxl"],
            "method": "direct visual inspection of retained scan plus structural/event and duration audit of retained OMR",
            "blockingFindings": blocking,
        },
        "blockingReason": "Autonomous promotion is blocked by the source/OMR measure-structure mismatch, all retained duration failures, blank source-visible measures, incomplete OMR key/time metadata, and only the watermark-intersected middle-system events. The derivative preserves detected events but does not invent rhythm, pitch, or lyrics.",
