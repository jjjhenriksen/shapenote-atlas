#!/usr/bin/env python3
"""Reconcile Helen Hills Hills' retained shape draft into an autonomous block."""
...
SOURCE_IMAGE = ROOT / "work/omr/478-helen-hills-hills/source.jpg"
RETAINED_IMAGE = ROOT / "work/source-images/2025/478-helen-hills-hills-8a9d694f6f.jpg"
RAW_OMR = ROOT / "work/omr/478-helen-hills-hills/source.mxl"
WORKING_OMR = ROOT / "work/omr/cleaned-normalized-v2-478-helen-hills-hills-8a9d694f6f/work__source-images__2025__478-helen-hills-hills-8a9d694f6f.mxl"
PRIOR_DRAFT = ROOT / "work/omr/source-shape-review-drafts/2025/478-source-shape-review.mxl"
OUTPUT = ROOT / "work/omr/autonomous-transcriptions/2025/478-helen-hills-hills-source-correction.mxl"
AUDIT = ROOT / "work/source-transcriptions/2025/478-source-shape-autonomous-blocked-comparison.json"
...
def update_xml(xml_bytes: bytes, source_hash: str, working_hash: str) -> bytes:
    ...
    fields = {
        "atlas-review-queue-id": "sh2025/478",
...
def main() -> int:
    ...
    blocking = [
        "The immutable page visibly identifies HELEN HILLS HILLS. S.M., A minor, 4/4, Charles Wesley (v.1 1742, v.2 1740), Allison Blake Steel (2021), four vocal parts, source-visible lyrics, repeat bars with numbered first/second endings, and a terminal double bar; a diagonal DO NOT COPY watermark intersects the middle systems.",
        "Audiveris reports 19 raw measures (9 in the first system and 10 in the second), matching the normalized-v2 export of 19 measures per part but not the retained source MXL's 17 measures per part. The normalized-v2 working score contains 118 pitched events, 25 empty exported measures, and 64 of 76 exported part-measures fail the 4/4 duration target at divisions=2. Matching normalized measure counts do not establish the source event stream or durations.",
        "The retained OMR and corrected derivative contain no lyrics or repeat/ending elements. Their 118 four-shape noteheads are derived from OMR pitch steps plus the observed A-minor key, not independently verified against every printed notehead. No unsupported event, lyric, repeat, or obscured watermark-intersected material was fabricated.",
        "No authorized exact-edition structured Helen Hills Hills witness was available. Alternate-edition records were not used to fill notes, durations, lyrics, repeats, or shapes.",
    ]
    audit = {
        "queueId": "sh2025/478", "edition": "Sacred Harp, 2025 Edition", "songNo": "478", "title": "Helen Hills Hills",
        "comparisonStatus": "autonomously-blocked", "autonomousDecision": "blocked", "safeToPromote": False, "humanReviewRequired": False,
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=478", "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/400-499/478-Helen-Hills-Hills/478.jpg",
            "sourceImagePath": str(SOURCE_IMAGE.relative_to(ROOT)), "sourceImageSha256": source_hash, "immutable": True,
            "directObservations": {
                "header": "HELEN HILLS HILLS. S.M.", "composer": "Charles Wesley, v.1 1742; v.2 1740", "arranger": "Allison Blake Steel, 2021", "key": "A minor", "mode": "minor", "timeSignature": "4/4", "meter": "Short Meter (6,6,8,6)", "parts": 4,
                "sourceRawMeasuresFromAudiveris": 19, "sourceRawMeasuresBySystem": [9, 10], "exportedMeasuresByPart": {"P1": 19, "P2": 19, "P3": 19, "P4": 19},
        ...
        "candidateWitness": {"available": False, "candidateRole": "No authorized exact-edition structured Helen Hills Hills witness was available; alternate editions were not used."},
