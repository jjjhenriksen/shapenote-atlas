#!/usr/bin/env python3
"""Create a fail-closed, source-derived Restoration OMR derivative."""
...
IMAGE = ROOT / "work" / "omr" / "312b-restoration" / "source.jpg"
...
# A minor is relative to C major for four-shape spelling.
...
def transform() -> tuple[bytes, dict[str, object]]:
    with zipfile.ZipFile(SOURCE) as archive:
        ...
        for name, value in {
            "atlas-queue-id": "sh2025/312b",
            "atlas-transcription-status": "autonomously-blocked",
            "atlas-safe-to-promote": "false",
            "atlas-source-image": "work/omr/312b-restoration/source.jpg",
            ...
            "atlas-shape-encoding": "derived four-shape spelling from retained OMR pitches and source-visible A-minor key; not source-verified per event",
            ...
            "atlas-blocker": "The source visibly prints RESTORATION. 8s & 7s., A minor, 4/4, and four vocal parts, with denser source barline geometry than the retained six-measure OMR. Duration/event grouping fails at P1 m1=2,m2=14,m4=16,m5=31,m6=4; P2 m1=14,m2=32,m4=2,m5=20,m6=2; P3 m1=12,m2=38,m3=12,m4=12,m5=17; and P4 m1=10,m2=17,m3=6,m4=6,m5=24,m6=4, using source 4/4 with retained divisions=2. The retained OMR does not encode the source key/mode or time signature. Watermark intersections are separately unresolved only in the middle systems.",
        }.items():
...
def main() -> int:
    ...
    blocking = [
        "The retained source scan visibly prints RESTORATION. 8s & 7s., A minor, 4/4, and four vocal parts; its barline geometry is denser than the retained six-measure OMR per part.",
        "The retained OMR duration/event grouping fails in the named part/measure groups against source 4/4; the source/OMR partition mismatch prevents event-level completion even though no OMR measure is blank.",
        "The retained OMR does not encode the source key/mode or time signature; the derivative corrects source metadata without silently rewriting event pitches.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=312b",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/300-399/312b-Restoration/312b.jpg",
            "sourceImagePath": "work/omr/312b-restoration/source.jpg",
            "sourceImageSha256": image_hash,
            "immutable": True,
            "directObservations": {
                "header": "RESTORATION. 8s & 7s.",
                "key": "A minor",
                "timeSignature": "4/4",
                "meter": "Particular Meter (8s & 7s.)",
                "parts": 4,
                "sourceMeasureStructure": "source scan visibly contains denser barline divisions than the retained six-measure OMR; exact source count not asserted here",
                "watermarkAffectedRegions": "middle-system note intersections only",
            },
        },
        "inputOmr": {
            "path": "work/omr/312b-restoration/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/312b-autonomous-blocked.mxl",
            "sha256": output_hash,
            "summary": summary,
            "corrections": [
                "four part structure preserved",
                "source A-minor key/mode",
        ...
        "comparisonEvidence": {
            ...
            "renderedSourcePath": "work/omr/312b-restoration/source.jpg",
            "renderedDraftInputs": ["work/omr/312b-restoration/source.mxl"],
            "method": "direct visual inspection of retained scan plus structural/event and duration audit of retained OMR",
            "blockingFindings": blocking,
        },
        "blockingReason": "Autonomous promotion is blocked by the source/OMR measure-structure mismatch, named duration/event failures, missing source key/time metadata, and only the watermark-intersected middle-system events. The derivative preserves detected events but does not invent rhythm, pitch, or lyrics.",
