#!/usr/bin/env python3
"""Reconcile Lowndes' retained shape draft into an autonomous block."""
...
SOURCE_IMAGE = ROOT / "work/omr/487-lowndes/source.jpg"
RETAINED_IMAGE = ROOT / "work/source-images/2025/487-lowndes-1a94038399.jpg"
RAW_OMR = ROOT / "work/omr/487-lowndes/source.mxl"
WORKING_OMR = ROOT / "work/omr/cleaned-normalized-v2-487-lowndes-1a94038399/work__source-images__2025__487-lowndes-1a94038399.mxl"
PRIOR_DRAFT = ROOT / "work/omr/source-shape-review-drafts/2025/487-source-shape-review.mxl"
OUTPUT = ROOT / "work/omr/autonomous-transcriptions/2025/487-lowndes-source-correction.mxl"
AUDIT = ROOT / "work/source-transcriptions/2025/487-source-shape-autonomous-blocked-comparison.json"
...
def update_xml(xml_bytes: bytes, source_hash: str, working_hash: str) -> bytes:
    ...
    for part in children(root, "part"):
        ...
        # The scan prints F-sharp Minor; F-sharp is three sharps.
    ...
    fields = {
        "atlas-review-queue-id": "sh2025/487",
...
def main() -> int:
    ...
    blocking = [
        "The immutable page visibly identifies LOWNDES. L.M.D., F-sharp minor, 4/4, Stopford A. Brooke (1891), José R. Camacho-Cerna (2021), four vocal parts, source-visible lyrics, repeat bars with numbered first/second endings, and a terminal double bar; a diagonal DO NOT COPY watermark intersects the middle systems.",
        "Audiveris reports 19 raw measures (10 in the first system and 9 in the second), while the retained source MXL exports 17 measures per part and normalized-v2 exports 16 measures per part. The normalized-v2 working score contains 191 pitched events, 6 empty exported measures, and 46 of 64 exported part-measures fail the 4/4 duration target at divisions=4. The source event stream, durations, and measure topology are therefore not proven complete.",
        "The retained OMR and corrected derivative contain no lyrics or repeat/ending elements. Their 191 four-shape noteheads are derived from OMR pitch steps plus the observed F-sharp-minor key, not independently verified against every printed notehead. No unsupported event, lyric, repeat, or obscured watermark-intersected material was fabricated.",
        "No authorized exact-edition structured Lowndes witness was available. Alternate-edition records were not used to fill notes, durations, lyrics, repeats, or shapes.",
    ]
    audit = {
        "queueId": "sh2025/487", "edition": "Sacred Harp, 2025 Edition", "songNo": "487", "title": "Lowndes",
        "comparisonStatus": "autonomously-blocked", "autonomousDecision": "blocked", "safeToPromote": False, "humanReviewRequired": False,
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=487", "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/400-499/487-Lowndes/487.jpg",
            "sourceImagePath": str(SOURCE_IMAGE.relative_to(ROOT)), "sourceImageSha256": source_hash, "immutable": True,
            "directObservations": {
                "header": "LOWNDES. L.M.D.", "composer": "Stopford A. Brooke, 1891", "arranger": "José R. Camacho-Cerna, 2021", "key": "F# minor", "mode": "minor", "timeSignature": "4/4", "meter": "Long Meter Double (8,8,8,8,8,8,8,8)", "parts": 4,
                "sourceRawMeasuresFromAudiveris": 19, "sourceRawMeasuresBySystem": [10, 9], "exportedMeasuresByPart": {"P1": 16, "P2": 16, "P3": 16, "P4": 16},
        ...
        "candidateWitness": {"available": False, "candidateRole": "No authorized exact-edition structured Lowndes witness was available; alternate editions were not used."},
        ...
        "blockingReason": "Autonomous promotion is blocked by the 19-versus-16/17 measure topology discrepancy, 46-of-64 normalized-v2 4/4 duration failures, 6 empty exported measures, absent lyrics and source-confirmed per-note shapes, incomplete repeat/ending semantics, watermark-intersected notation, and lack of an authorized exact-edition structured witness. The corrected derivative remains review-only.",
