#!/usr/bin/env python3
"""Create a fail-closed, source-derived Schwab OMR derivative."""
...
SOURCE = ROOT / "work" / "omr" / "526-schwab" / "source.mxl"
IMAGE = ROOT / "work" / "omr" / "526-schwab" / "source.jpg"
OUTPUT = ROOT / "work" / "omr" / "autonomous-transcriptions" / "2025" / "526-autonomous-blocked.mxl"
AUDIT = ROOT / "work" / "source-transcriptions" / "2025" / "526-schwab-autonomous-comparison.json"
...
def transform() -> tuple[bytes, dict[str, object]]:
    with zipfile.ZipFile(SOURCE) as archive:
        ...
        for name, value in {
            "atlas-queue-id": "sh2025/526",
            "atlas-transcription-status": "autonomously-blocked",
            "atlas-safe-to-promote": "false",
            "atlas-source-image": "work/omr/526-schwab/source.jpg",
            ...
            "atlas-blocker": "The source visibly prints SCHWAB. L.M.H., F-sharp minor, 2/4, four vocal parts, and 16 measures per part. Chord-aware cursor duration fails against source 2/4 with retained divisions=2 at P1 m0=0,m2=2,m7=2,m8=5,m10=2,m14=0; P2 m0=2,m2=2,m9=0,m10=5,m11=2; P3 m0=2,m8=3,m10=5,m14=0,m15=0; and P4 m0=2,m3=6,m8=5. P1 m0,m14, P2 m9, and P3 m14,m15 are blank while the source shows notation. OMR key fields record fifths=2 without a mode in P1/P2/P3 and fifths=1 without a mode in P4, conflicting with source-visible F-sharp minor. Watermark intersections are separately unresolved only in the middle systems.",
        }.items():
...
def main() -> int:
    ...
    blocking = [
        "The retained source scan visibly prints SCHWAB. L.M.H., F-sharp minor, 2/4, four vocal parts, and 16 measures per part.",
        "Chord-aware cursor duration fails in the named part/measure groups against source 2/4; P1 m0,m14, P2 m9, and P3 m14,m15 are blank although the source visibly contains notation.",
        "The retained OMR key fields conflict with source-visible F-sharp minor: P1/P2/P3 record fifths=2 without a mode and P4 records fifths=1 without a mode; the derivative corrects source metadata without silently rewriting event pitches.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=526",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/500-599/526-Schwab/526.jpg",
            "sourceImagePath": "work/omr/526-schwab/source.jpg",
        ...
        "inputOmr": {
            "path": "work/omr/526-schwab/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/526-autonomous-blocked.mxl",
            "sha256": output_hash,
            "summary": summary,
            "corrections": [
        ...
        "comparisonEvidence": {
            ...
            "renderedSourcePath": "work/omr/526-schwab/source.jpg",
            "renderedDraftInputs": ["work/omr/526-schwab/source.mxl"],
