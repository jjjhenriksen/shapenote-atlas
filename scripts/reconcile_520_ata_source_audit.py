#!/usr/bin/env python3
"""Reconcile Ata's retained scan OMR into an autonomous block."""
...
def main() -> int:
    ...
    audit = {
        "queueId": "sh2025/520", "edition": "Sacred Harp, 2025 Edition", "songNo": "520", "title": "Ata",
        "comparisonStatus": "autonomously-blocked", "autonomousDecision": "blocked", "safeToPromote": False, "humanReviewRequired": False,
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=520", "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/500-599/520-Ata/520.jpg",
            "sourceImagePath": str(SOURCE_IMAGE.relative_to(ROOT)), "sourceImageSha256": source_hash, "immutable": True,
            "directObservations": {
                "header": "ATA. L.M.", "composer": "Isaac Watts, 1709", "arranger": "Jacob E. Stebly, 2017", "key": "B-flat major", "mode": "major", "timeSignature": "4/4", "meter": "Long Meter (8,8,8,8)", "parts": 4,
                "sourceRawMeasuresFromAudiveris": 13, "sourceRawMeasuresBySystem": [13], "exportedMeasuresByPart": {"P1": 11, "P2": 11, "P3": 11, "P4": 11},
