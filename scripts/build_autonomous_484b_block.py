#!/usr/bin/env python3
"""Create a fail-closed, source-derived Parwich OMR derivative."""
...
SOURCE = ROOT / "work" / "omr" / "484b-parwich" / "source.mxl"
IMAGE = ROOT / "work" / "omr" / "484b-parwich" / "source.jpg"
OUTPUT = ROOT / "work" / "omr" / "autonomous-transcriptions" / "2025" / "484b-autonomous-blocked.mxl"
AUDIT = ROOT / "work" / "source-transcriptions" / "2025" / "484b-parwich-autonomous-comparison.json"

# A minor's relative-major four-shape spelling is C-major: C fa, D sol,
# E la, F fa, G sol, A la, B mi.
STEPS = ["C", "D", "E", "F", "G", "A", "B"]
    ...
    with zipfile.ZipFile(SOURCE) as archive:
        ...
        for part in parts:
            ...
            for note in [item for item in part.iter() if ln(item.tag) == "note"]:
                ...
                head.text = SHAPES[STEPS.index(step)]
        ...
        for name, value in {
            "atlas-queue-id": "sh2025/484b",
            "atlas-transcription-status": "autonomously-blocked",
            "atlas-safe-to-promote": "false",
            "atlas-source-image": "work/omr/484b-parwich/source.jpg",
            ...
            "atlas-blocker": "The source visibly has four parts and eight 4/4 measures, but retained OMR duration/event grouping is unsupported at P1 m1,m3-m8, P2 m1-m8, P3 m1,m3-m8, and P4 m1-m3,m5,m7-m8. Only P1 m2, P3 m2, and P4 m4,m6 reach the retained target-length heuristic; this does not establish note-level source fidelity. Watermark intersections in the middle systems remain separately unresolved.",
        }.items():
...
def main() -> int:
    ...
    blocking = [
        "The retained source scan visibly prints PARWICH L.M., A minor, Long Meter (8s, 8s, 8s & 8s.), four vocal parts, and eight measures per part.",
        "The retained OMR has eight measures per part and no blank measures, but its duration/event grouping is unresolved at P1 m1,m3-m8, P2 m1-m8, P3 m1,m3-m8, and P4 m1-m3,m5,m7-m8 against the source 4/4 layout.",
        "The derivative adds only deterministic four-shape tags to retained pitched events; it does not infer missing source events or rewrite unsupported rhythms.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=484b",
            "sourceImagePath": "work/omr/484b-parwich/source.jpg",
        ...
        "inputOmr": {
            "path": "work/omr/484b-parwich/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/484b-autonomous-blocked.mxl",
            "sha256": output_hash,
            "summary": summary,
            "corrections": [
        ...
        "comparisonEvidence": {
            ...
            "renderedSourcePath": "work/omr/484b-parwich/source.jpg",
            "renderedDraftInputs": ["work/omr/484b-parwich/source.mxl"],
            "method": "direct visual inspection of retained scan plus structural/event audit of retained OMR",
            "blockingFindings": blocking,
        },
        "blockingReason": "Autonomous promotion is blocked by unresolved duration/event grouping in the named measures and watermark-obscured intersections. The derivative preserves detected events but does not invent rhythm, pitch, or lyrics.",
