#!/usr/bin/env python3
"""Create a fail-closed, source-derived Penn OMR derivative."""
...
SOURCE = ROOT / "work" / "omr" / "501t-penn" / "source.mxl"
IMAGE = ROOT / "work" / "omr" / "501t-penn" / "source.jpg"
OUTPUT = ROOT / "work" / "omr" / "autonomous-transcriptions" / "2025" / "501t-autonomous-blocked.mxl"
AUDIT = ROOT / "work" / "source-transcriptions" / "2025" / "501t-penn-autonomous-comparison.json"

# Penn is printed in A major; the four-shape syllables follow the source key.
...
def transform() -> tuple[bytes, dict[str, object]]:
    with zipfile.ZipFile(SOURCE) as archive:
        ...
        for name, value in {
            "atlas-queue-id": "sh2025/501t",
            "atlas-transcription-status": "autonomously-blocked",
            "atlas-safe-to-promote": "false",
            "atlas-source-image": "work/omr/501t-penn/source.jpg",
            ...
            "atlas-blocker": "The source visibly prints PENN. C.M., A major, 4/4, four vocal parts, and nine measures per part. Retained OMR duration/event grouping fails at P1 m1=0,m2=3,m4=5,m6=8,m8=3; P2 m1=0,m2=2,m4=15,m5=5,m6=11,m7=5,m8=3; P3 m1=0,m2=1,m4=16,m6=6,m8=2,m9=2; and P4 m1=1,m2=1,m4=6,m5=2,m6=3,m8=3, using source 4/4 with retained divisions=1. P1/P2/P3 m1 are blank and P4 m1 contains only a partial event while the source shows notation. OMR key fields record fifths=1 without a mode in P1/P2/P3 and no key in P4, conflicting with source-visible A major. Watermark intersections are separately unresolved only in the middle systems.",
        }.items():
...
def main() -> int:
    ...
    blocking = [
        "The retained source scan visibly prints PENN. C.M., A major, 4/4, four vocal parts, and nine measures per part.",
        "The retained OMR duration/event grouping fails in the named part/measure groups against source 4/4; P1/P2/P3 m1 are blank and P4 m1 is partial although the source visibly contains notation.",
        "The retained OMR key fields conflict with source-visible A major: P1/P2/P3 record fifths=1 without a mode and P4 has no key; the derivative corrects source metadata without silently rewriting event pitches.",
    ...
    audit = {
        ...
        "sourceAuthority": {
            "sourcePageUrl": "https://fasola.org/indexes/2025/?p=501t",
            "sourceImageUrl": "https://sacredharpbremen.org/wp-content/uploads/songs/500-599/501t-Penn/501t.jpg",
            "sourceImagePath": "work/omr/501t-penn/source.jpg",
        ...
        "inputOmr": {
            "path": "work/omr/501t-penn/source.mxl",
            "sha256": source_hash,
            "status": "retained-source-scan-omr",
        },
        "correctedDraft": {
            "path": "work/omr/autonomous-transcriptions/2025/501t-autonomous-blocked.mxl",
            "sha256": output_hash,
            "summary": summary,
            "corrections": [
        ...
        "comparisonEvidence": {
            ...
            "renderedSourcePath": "work/omr/501t-penn/source.jpg",
            "renderedDraftInputs": ["work/omr/501t-penn/source.mxl"],
            "method": "direct visual inspection of retained scan plus structural/event and duration audit of retained OMR",
            "blockingFindings": blocking,
        },
        "blockingReason": "Autonomous promotion is blocked by the named duration/event failures, blank/partial source-visible first measures, conflicting OMR key fields, and only the watermark-intersected middle-system events. The derivative preserves detected events but does not invent rhythm, pitch, or lyrics.",
